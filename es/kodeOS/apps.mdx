...
Las comunidades open source se basan en compartir conocimientos y recursos. Por eso, la piedra angular del kode dot es que tus códigos se conviertan en aplicaciones para 
...
Una vez subido, te en la pantalla de tu kode dot te aparecerá dos opciones, correr directamente el código o transformar el código en una aplicación y guardarla en tu kode dot.
<Frame>
...
Cuando tengas el código validado y funcionando, podrás darle al botón de crear aplicación. Puedes elegir qué si quieres cambiarle el nombre y seleccinar en qué categoría quieres guardarla.
