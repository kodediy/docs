...
<Info>Ve a [Expansor de pines](/es/kode-dot/io-expander)  para más información.</Info>
...
## Código de ejemplo
Con este código puedes comprobar el funcionamiento de los botones. Conecta el kode dot al serial monitor y verás qué botón se ha pulsado.
