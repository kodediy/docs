...
<Tip>If you're not going to use your Kode Dot for a **long period of time**, you can press the button on the bottom right for **5 seconds** to turn it off completely.</Tip>
...
<Steps>
  ...
  <Step title="Install ESP32 boards">
    ...
    ![Board Manager](/images/kode-dot/quickstart/board-manager.png)
  </Step>
  <Step title="Select the Kode Dot as the board">
    Select the Kode Dot as the board in "Tools > Board > esp32 > Kode Dot".
    ![Select Kode Dot](/images/kode-dot/quickstart/kode-dot-board.png)
  </Step>
</Steps>
